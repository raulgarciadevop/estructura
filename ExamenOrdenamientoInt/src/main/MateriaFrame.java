 ...
 * @author SB-A1
 */
public class MateriaFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Materia (Ordenamiento)");
    ...
    private void add2r() {
        ...
        int sc=tblAlumnos.getSelectedColumn();
        Materia[] A = new Materia[tam];

        for (int i = 0; i < tam; i++) {
            A[i] = new Materia(dtm.getValueAt(i, 0).toString(), Integer.parseInt(dtm.getValueAt(i,1).toString()));
        }

        //Elegir el metodo de ordenamiento:
        if(cBubble.isSelected())
            ord.bubble(A, sc);//Funciona
        
        if(cQuicksort.isSelected())
            ord.quicksort(A, 0, A.length-1, sc);//Funciona
        
        if(cShell.isSelected())
            ord.shell(A, true, sc);//Funciona
        ...
        for(int i=0;i<dtm.getRowCount();i++){
            dtm.setValueAt(A[i].getNombre(), i, 0);
            dtm.setValueAt(A[i].getCalif(), i, 1);
        }
    }
    ...
    private void gen(){
        ...
        dtm.setValueAt("9", 0, 1);
        
        dtm.setValueAt("AL", 1, 0);
        dtm.setValueAt("243", 1, 1);
        
        dtm.setValueAt("ZOL1", 2, 0);
        dtm.setValueAt("12", 2, 1);
        
        dtm.setValueAt("ads3", 3, 0);
        dtm.setValueAt("1", 3, 1);
        
        dtm.setValueAt("AL09", 4, 0);
        dtm.setValueAt("55", 4, 1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MateriaFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MateriaFrame().setVisible(true);
            }
        });
    }
