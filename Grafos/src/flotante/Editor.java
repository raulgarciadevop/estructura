...
public class Editor extends javax.swing.JFrame {
    ...
    private void mnuAnalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuAnalizarActionPerformed
        ...
        for(int p=0;p<palabras.length;p++){
            if(GrafoFlotante.eside(palabras[p]))
        ...
        showMessageDialog(this," No es flotante.");
        */
        ...
        for(int i=0;i<cad.length();i++){
            ...
            if(c>=65 && c<=90 || c>=97 && c<=122 || c>=48 && c<= 57)
                token=token+(char)c;
            else if(GrafoFlotante.esOp(c+"")!=-1){
                W[p++]=token; token="";
                W[p++]=(char)c+"";
            }
        }
        ...
        for(int i=0;i<cad.length();i++)
            showMessageDialog(this, W[i]);
        
        //TAREA PARA VACACIONES, TERMINARLO
